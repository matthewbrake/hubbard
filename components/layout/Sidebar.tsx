...
import { DashboardIcon, UsersIcon, WrenchScrewdriverIcon, ChartBarIcon, DocumentTextIcon } from '../ui/Icons';
...
export const Sidebar: React.FC<SidebarProps> = ({ activeView, setActiveView }) => {
  ...
  return (
    <div className="flex flex-col w-64 bg-gray-900 border-r border-gray-700 p-4 space-y-2">
